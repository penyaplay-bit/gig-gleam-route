...
export const ARTISTS: Artist[] = [
  ...
  {
    id: "moliehi",
    name: "Moliehi Sesinyi",
    tagline: "Afro-soul · corporate favourite",
    homeCityId: "maseru",
    basePerformanceFee: 42000,
    photo: "❋",
    driverAllowance: 400,
    perDiem: 400,
    accomPerRoom: 800,
    ...
    discountPolicy: "capped",
    discountCapPct: 60,
  },
  {
    id: "kboks",
    name: "K.Boks",
    tagline: "Hip-hop · SA touring",
    homeCityId: "jhb",
    basePerformanceFee: 68000,
    photo: "▲",
    driverAllowance: 600,
    perDiem: 550,
    accomPerRoom: 1200,
    proximityWindowDays: 4,
    proximityRadiusKm: 250,
    discountPolicy: "full",
  },
];
...
export const CONFIRMED_BOOKINGS: ConfirmedBooking[] = [
  ...
  { id: "b3", artistId: "moliehi", cityId: "leribe", date: "2026-07-18", label: "Wedding" },
  { id: "b4", artistId: "kboks", cityId: "pta", date: "2026-07-11", label: "Album launch" },
  { id: "b5", artistId: "kboks", cityId: "durban", date: "2026-08-02", label: "Beach festival" },
];

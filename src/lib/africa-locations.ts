...
export const SADC_COUNTRIES: CountryEntry[] = [
  ...
  { name: "South Africa", sadc: true, cities: [
    "Johannesburg", "Pretoria", "Cape Town", "Durban", "Bloemfontein", "Port Elizabeth (Gqeberha)", "East London", "Polokwane", "Nelspruit (Mbombela)", "Kimberley", "Rustenburg", "Welkom", "Soweto", "Sandton", "Midrand", "Centurion", "Roodepoort", "Randburg", "Alberton", "Boksburg", "Benoni", "Kempton Park", "Germiston", "Krugersdorp", "Vereeniging", "Vanderbijlpark", "Springs", "Brakpan", "Tembisa", "Katlehong", "Mamelodi", "Atteridgeville", "Pietermaritzburg", "Pinetown", "Umlazi", "Chatsworth", "Newcastle", "Richards Bay", "Empangeni", "Ladysmith", "Estcourt", "Margate", "Ballito", "Umhlanga", "Stellenbosch", "Paarl", "Worcester", "George", "Knysna", "Mossel Bay", "Oudtshoorn", "Hermanus", "Somerset West", "Bellville", "Khayelitsha", "Mitchells Plain", "Uitenhage (Kariega)", "Grahamstown (Makhanda)", "Mthatha", "Queenstown (Komani)", "King William's Town", "Jeffreys Bay", "Plettenberg Bay", "Beaufort West", "Upington", "Springbok", "Kuruman", "Kathu", "De Aar", "Mahikeng", "Klerksdorp", "Potchefstroom", "Brits", "Mokopane", "Tzaneen", "Thohoyandou", "Musina", "Bela-Bela", "Modimolle", "Lephalale", "Giyani", "Witbank (eMalahleni)", "Middelburg", "Secunda", "Standerton", "Ermelo", "Piet Retief", "Barberton", "White River", "Sabie", "Hazyview", "Komatipoort", "Sasolburg", "Parys", "Kroonstad", "Bethlehem", "Harrismith", "QwaQwa", "Thaba Nchu", "Botshabelo"
  ] },

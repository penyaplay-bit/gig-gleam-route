...
import { LayoutDashboard, Users, Package, Calendar, LogOut, Table2, Radio, Gauge, Sparkles, ShieldCheck } from "lucide-react";
...
function AdminShell() {
  ...
  const nav = [
    ...
    { to: "/admin/gigs", label: "Marketplace", Icon: Sparkles },

...
const CONFIG: Record<TrustBadgeKind, { label: string; explain: string; Icon: typeof ShieldCheck; tone: string }> = {
  identity: {
    ...
    explain: "Penya Play has confirmed this performer's legal identity.",
    Icon: ShieldCheck,
    tone: "text-emerald-300 border-emerald-400/40 bg-emerald-500/10",
  },
  family_event: {
    label: "Family Event Verified",
    explain: "Additional checks and references have been completed for family and children's events.",
    Icon: Baby,
    tone: "text-pink-200 border-pink-400/40 bg-pink-500/10",
  },
  business: {
    label: "Business Verified",
    explain: "Business registration and authorized representative have been confirmed.",
    Icon: Building2,
    tone: "text-blue-200 border-blue-400/40 bg-blue-500/10",
  },
  payment_protected: {
    label: "Payment Protected",
    explain: "Deposits and payments made through Penya Play are protected by our booking guarantee.",
    Icon: CreditCard,
    tone: "text-primary border-primary/40 bg-primary/10",
  },
  highly_rated: {
    label: "Highly Rated",
    explain: "This performer has consistently strong reviews across recent bookings.",
    Icon: Star,
    tone: "text-yellow-200 border-yellow-400/40 bg-yellow-500/10",
  },
  booking_history: {
    label: "Booking History Verified",
    explain: "A verified track record of completed bookings on Penya Play.",
    Icon: History,
